import type { RewriteRequest, RewriteResponse, VocabSuggestRequest, VocabWord } from "../types";
...
export async function suggestVocabulary(req: VocabSuggestRequest): Promise<VocabWord[]> {
